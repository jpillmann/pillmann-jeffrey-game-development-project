...
namespace JP
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        // Camera follows Player (targetTransform = Players Transform)
        ...
        // Detect Camera Collision with Environment using a Sphere Cast
        ...
        // Searches Distance from Player for Lock On Targets
                ...
                if (character != null)
                {
                    ...
                    if (character.transform.root != targetTransform.transform.root && viewableAngle > -50 && viewableAngle < 50 && distanceFromTarget <= maximumLockOnDistance)
                    {
                        if (Physics.Linecast(playerManager.lockOnTransform.position, character.lockOnTransform.position, out hit))
                        {
                            ...
                            {
                                // Cannot Lock On because there is an object in the way
                            }
                            else
                            {
